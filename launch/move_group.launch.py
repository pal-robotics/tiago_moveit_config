...
def generate_launch_description():
    ...
    robot_description = {"robot_description": generate_robot_description_action()}

    # TODO Hard coded for now for testing
    robot_description_semantic_config = load_file(
        "tiago_moveit_config", "config/srdf/tiago_pal-gripper.srdf"
    )
    ...
    moveit_simple_controllers_yaml = load_yaml(
        "tiago_moveit_config", "config/controllers/controllers_pal-gripper.yaml"
    )
    moveit_controllers = {
